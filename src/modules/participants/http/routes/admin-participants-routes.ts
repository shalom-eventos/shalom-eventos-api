...
import { exportParticipantsController } from '../controllers/export-participants-controller';
...
export async function adminParticipantsRoutes(app: FastifyInstance) {
  ...
  app.get('/participants/export', adminMiddlewares, exportParticipantsController);
}
