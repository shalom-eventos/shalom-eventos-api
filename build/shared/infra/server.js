...
async function addressRoutes(app2) {
  ...
  app2.addHook("onRequest", verifyUserRole("ADMINISTRATOR"));
  app2.post("/addresses/event/:event_id", createAddressToEventController);
  app2.get("/addresses/:id", getAddressController);
  app2.put("/addresses/:id", updateAddressController);
}
...
// src/shared/infra/app.ts
var upload = (0, import_fastify_multer2.default)(upload_default.multer);
