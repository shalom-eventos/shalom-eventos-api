...
var validate_registration_controller_exports = {};
__export(validate_registration_controller_exports, {
  validateRegistrationController: () => validateRegistrationController
});
module.exports = __toCommonJS(validate_registration_controller_exports);
...
async function validateRegistrationController(request, reply) {
  const paramsSchema = import_zod2.z.object({
    registration_id: import_zod2.z.string().uuid()
  }).strict();
