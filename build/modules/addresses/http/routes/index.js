...
__export(routes_exports, {
  addressesRoutes: () => addressesRoutes
});
...
async function updateAddressToParticipantController(request, reply) {
  ...
  const bodySchema = import_zod6.z.object({
    ...
    street_number: import_zod6.z.string().optional(),
    complement: import_zod6.z.string().optional(),
    zip_code: import_zod6.z.string().optional(),
    district: import_zod6.z.string().optional(),
